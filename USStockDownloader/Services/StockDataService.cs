...
public class StockDataService : IStockDataService
{
    ...
    public async Task<List<StockData>> GetStockDataAsync(string symbol, DateTime startDate, DateTime endDate)
    {
        ...
        var url = $"https://query1.finance.yahoo.com/v8/finance/chart/{cleanSymbol}?period1={unixStartTime}&period2={unixEndTime}&interval=1d";
    ...
    {
        var filePath = Path.Combine(outputPath, $"{symbol.Split(',')[0]}.csv");
